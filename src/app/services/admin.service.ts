...
import { BehaviorSubject, Observable, Subject, of, scheduled, shareReplay } from 'rxjs';
...
export class AdminService {
  private hasBeenChanged = new BehaviorSubject<boolean>(false);
  public hasBeenChanged$: Observable<boolean> =
    this.hasBeenChanged.asObservable();

  private candyStoragePreview = new BehaviorSubject<CandyStorage>(new CandyStorage(
    new Candy(
      'Test',
      'Description',
      'Flavour',
